         ...
         <div class="col-12">
             ...
             <div class="scrollable-gridview">
                 <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-light custom-table my-5 " AllowPaging="true" PageSize="5" OnPageIndexChanging="gvList_PageIndexChanging">
                    ...
                    <Columns>
                         <asp:BoundField DataField="Patient_Name" HeaderText="Patient Name" ItemStyle-Width="180" />
                         <asp:BoundField DataField="Patient_ID" HeaderText="Patient ID" ItemStyle-Width="70" />
                         <asp:BoundField DataField="In_Employee_Name" HeaderText="Employee Name" ItemStyle-Width="180" />
                         <asp:BoundField DataField="In_Employee_ID" HeaderText="Employee ID" ItemStyle-Width="70" />
                         <asp:BoundField DataField="Created_Date" HeaderText="Created Date" ItemStyle-Width="160" />
                         <asp:BoundField DataField="Location_In_Morgue" HeaderText="Location In Morgue" ItemStyle-Width="150" />
                         <asp:BoundField DataField="Funeral_Home" HeaderText="Funeral Home" ItemStyle-Width="180" />
                         <asp:BoundField DataField="Funeral_Home_Employee" HeaderText="Funeral Home Employee" ItemStyle-Width="180" />
                         <asp:BoundField DataField="Out_Employee_Name" HeaderText="Release Employee Name" ItemStyle-Width="180" />
                         <asp:BoundField DataField="Out_Employee_ID" HeaderText="Release Employee ID" ItemStyle-Width="70" />
                         <asp:BoundField DataField="Picked_Up_Date" HeaderText="Picked Up Date" ItemStyle-Width="160" />
                     </Columns>
                 </asp:GridView>
             </div>
