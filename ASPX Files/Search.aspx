                ...
                <section class="row" aria-labelledby="searchPatientTitle">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10">
                                ...
                                <section class="row d-flex justify-content-end">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Button ID="btnSubmit" CssClass="btn btn-primary btn-lg col-md-12" runat="server" Text="Submit" OnClick="Submit_Click" />
                                    </div>
                                </section>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <!-- Add the GIF image below -->
                                                <img src="https://media.tenor.com/N2qCkbdl5RIAAAAM/laughing-grim-reaper.gif" alt="Success GIF" />
                    ...
                    <script type="text/javascript">
                        function showConfirmation() {
                            ...
                            document.getElementById('lblConfirmationMessage').innerText = 'Information Updated Successfully';
                        }
